package com.ashgen.groupchatapp.service;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (/* Check if data needs to be processed by long running job */ true) {
                ...
                Log.d(TAG, "onMessageReceived: "+remoteMessage.getData().get("name"));

                sendNotification(remoteMessage.getData().get("text"),remoteMessage.getData().get("name"));
            } else {
